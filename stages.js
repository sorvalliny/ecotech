  ...
  var DEFAULT = [
    {
      ...
      goal: 'Быстро оценить: стоит ли браться. Получить решение за 5 рабочих дней.',
      fork: null,
      committee: 'ФМК → УК',
      duration: 'до 5 дней',
      color: '#FFB830',
    ...
    },
    {
      ...
      fork: 'Развилка: делаем MVP сами или передаём в коммерцию (если несложное и понятное)',
      committee: 'ФМК → ТК → УК',
      duration: '3–6 нед',
      color: '#B3E5FC',
    ...
    },
    {
      ...
      fork: 'Развилка: проект остаётся в экосистеме (технологический) или передаётся в коммерцию (завязан на категории/закупки)',
      committee: 'ФМК → ТК → УК',
      duration: '1–3 мес',
      color: '#00D4B4',
