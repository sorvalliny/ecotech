...
(function() {
  ...
  var DEFAULT_USERS = [
    ...
    { id: 'U016', name: 'PM WB Kids',        email: 'pm.kids@rwb.ru',         role: 'pm',       department: 'innovation', team: 'WB Kids', active: true, assignments: [{ productId: 'ECO-05', scope: 'all', role: 'owner' }], productIds: ['ECO-05'], createdBy: 'system', createdAt: '2026-03-23' },
    { id: 'U017', name: 'PM WB Sport',       email: 'pm.sport@rwb.ru',        role: 'pm',       department: 'innovation', team: 'WB Sport', active: true, assignments: [{ productId: 'ECO-06', scope: 'all', role: 'owner' }], productIds: ['ECO-06'], createdBy: 'system', createdAt: '2026-03-23' },
    { id: 'U018', name: 'PM WB Встречи',     email: 'pm.meetings@rwb.ru',     role: 'pm',       department: 'innovation', team: 'WB Встречи', active: true, assignments: [{ productId: 'ECO-09', scope: 'all', role: 'owner' }], productIds: ['ECO-09'], createdBy: 'system', createdAt: '2026-03-23' },
    { id: 'U020', name: 'PM WB Академия',    email: 'pm.academy@rwb.ru',      role: 'pm',       department: 'education', team: 'WB Академия', active: true, assignments: [{ productId: 'EDU-01', scope: 'all', role: 'owner' }], productIds: ['EDU-01'], createdBy: 'system', createdAt: '2026-03-23' },
    { id: 'U021', name: 'PM WB Курсы',       email: 'pm.courses@rwb.ru',      role: 'pm',       department: 'education', team: 'WB Курсы', active: true, assignments: [{ productId: 'EDU-02', scope: 'all', role: 'owner' }], productIds: ['EDU-02'], createdBy: 'system', createdAt: '2026-03-23' },
    { id: 'U022', name: 'PM WB Стажировки',  email: 'pm.intern@rwb.ru',       role: 'pm',       department: 'education', team: 'WB Стажировки', active: true, assignments: [{ productId: 'EDU-03', scope: 'all', role: 'owner' }], productIds: ['EDU-03'], createdBy: 'system', createdAt: '2026-03-23' },
    { id: 'U004', name: 'CEO BU EDU',         email: 'ceo.edu@rwb.ru',         role: 'lead',     department: 'education', team: 'Руководство', active: true, assignments: [], productIds: [], createdBy: 'system', createdAt: '2026-03-23' },
