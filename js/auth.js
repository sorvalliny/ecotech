...
(function() {
  ...
  var DEFAULT_USERS = [
    ...
    { id: 'U020', name: 'PM WB EdTech',       email: 'pm.edtech@rwb.ru',       role: 'pm',       department: 'education', team: 'WB EdTech', active: true, assignments: [{ productId: 'EDU-01', scope: 'all', role: 'owner' }], productIds: ['EDU-01'], createdBy: 'system', createdAt: '2026-03-23' },
    { id: 'U021', name: 'PM Мост поколений', email: 'pm.bridge@rwb.ru',       role: 'pm',       department: 'education', team: 'Мост поколений', active: true, assignments: [{ productId: 'EDU-02', scope: 'all', role: 'owner' }], productIds: ['EDU-02'], createdBy: 'system', createdAt: '2026-03-23' },
    { id: 'U022', name: 'PM Tingli',         email: 'pm.tingli@rwb.ru',       role: 'pm',       department: 'education', team: 'Tingli', active: true, assignments: [{ productId: 'EDU-03', scope: 'all', role: 'owner' }], productIds: ['EDU-03'], createdBy: 'system', createdAt: '2026-03-23' },
