...
(function() {
  ...
  var DEFAULT_USERS = [
    ...
    { id: 'U010', name: 'PM Wibes',         email: 'pm.wibes@orbita.demo',        role: 'pm',       department: 'innovation', assignments: [{ productId: 'ECO-01', scope: 'all', role: 'owner' }], active: true, createdBy: 'system', createdAt: '2026-03-18', productIds: ['ECO-01'], contact: '', team: 'Wibes' },
    { id: 'U011', name: 'PM WB Цифровой',   email: 'pm.digital@orbita.demo',      role: 'pm',       department: 'innovation', assignments: [{ productId: 'ECO-02', scope: 'all', role: 'owner' }], active: true, createdBy: 'system', createdAt: '2026-03-18', productIds: ['ECO-02'], contact: '', team: 'WB Цифровой' },
    { id: 'U012', name: 'PM WB Stream',     email: 'pm.stream@orbita.demo',       role: 'pm',       department: 'innovation', assignments: [{ productId: 'ECO-03', scope: 'all', role: 'owner' }], active: true, createdBy: 'system', createdAt: '2026-03-18', productIds: ['ECO-03'], contact: '', team: 'WB Stream' },
    { id: 'U013', name: 'PM WB Книги',      email: 'pm.books@orbita.demo',        role: 'pm',       department: 'innovation', assignments: [{ productId: 'ECO-04', scope: 'all', role: 'owner' }], active: true, createdBy: 'system', createdAt: '2026-03-18', productIds: ['ECO-04'], contact: '', team: 'WB Книги' },
    { id: 'U014', name: 'PM WB Messenger',  email: 'pm.messenger@orbita.demo',    role: 'pm',       department: 'innovation', assignments: [{ productId: 'ECO-07', scope: 'all', role: 'owner' }], active: true, createdBy: 'system', createdAt: '2026-03-18', productIds: ['ECO-07'], contact: '', team: 'WB Messenger' },
    { id: 'U015', name: 'PM WB Boards',     email: 'pm.boards@orbita.demo',       role: 'pm',       department: 'innovation', assignments: [{ productId: 'ECO-08', scope: 'all', role: 'owner' }], active: true, createdBy: 'system', createdAt: '2026-03-18', productIds: ['ECO-08'], contact: '', team: 'WB Boards' },
    { id: 'U016', name: 'PM WB Kids',        email: 'pm.kids@orbita.demo',         role: 'pm',       department: 'innovation', team: 'WB Kids', active: true, assignments: [{ productId: 'ECO-05', scope: 'all', role: 'owner' }], productIds: ['ECO-05'], createdBy: 'system', createdAt: '2026-03-23' },
    { id: 'U017', name: 'PM WB Sport',       email: 'pm.sport@orbita.demo',        role: 'pm',       department: 'innovation', team: 'WB Sport', active: true, assignments: [{ productId: 'ECO-06', scope: 'all', role: 'owner' }], productIds: ['ECO-06'], createdBy: 'system', createdAt: '2026-03-23' },
    { id: 'U018', name: 'PM WB Встречи',     email: 'pm.meetings@orbita.demo',     role: 'pm',       department: 'innovation', team: 'WB Встречи', active: true, assignments: [{ productId: 'ECO-09', scope: 'all', role: 'owner' }], productIds: ['ECO-09'], createdBy: 'system', createdAt: '2026-03-23' },
    { id: 'U020', name: 'PM WB EdTech',       email: 'pm.edtech@orbita.demo',       role: 'pm',       department: 'education', team: 'WB EdTech', active: true, assignments: [{ productId: 'EDU-01', scope: 'all', role: 'owner' }], productIds: ['EDU-01'], createdBy: 'system', createdAt: '2026-03-23' },
    { id: 'U021', name: 'PM Мост поколений', email: 'pm.bridge@orbita.demo',       role: 'pm',       department: 'education', team: 'Мост поколений', active: true, assignments: [{ productId: 'EDU-02', scope: 'all', role: 'owner' }], productIds: ['EDU-02'], createdBy: 'system', createdAt: '2026-03-23' },
    { id: 'U022', name: 'PM Tingli',         email: 'pm.tingli@orbita.demo',       role: 'pm',       department: 'education', team: 'Tingli', active: true, assignments: [{ productId: 'EDU-03', scope: 'all', role: 'owner' }], productIds: ['EDU-03'], createdBy: 'system', createdAt: '2026-03-23' },
    { id: 'U004', name: 'CEO BU EDU',         email: 'ceo.edu@orbita.demo',         role: 'lead',     department: 'education', team: 'Руководство', active: true, assignments: [], productIds: [], createdBy: 'system', createdAt: '2026-03-23' },
    { id: 'U030', name: 'Заказчик Wibes',    email: 'stakeholder@orbita.demo',     role: 'stakeholder', department: 'innovation', team: 'Бизнес', active: true, assignments: [{ productId: 'ECO-01', scope: ['I-001', 'I-002'] }], productIds: ['ECO-01'], createdBy: 'system', createdAt: '2026-03-23' }
  ];
